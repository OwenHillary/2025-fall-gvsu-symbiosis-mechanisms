# 2025-10-23 - Health mode evolvable interaction values with differential rewards
...
experiment_slug <- "2025-10-23-health-evo-int-diff-rewards"
...
summary_data <- summary_data %>%
  ...
  mutate(
    treatment = paste0(
      ...
      "_DM=", MUTUALIST_CYCLE_DONATE_MULTIPLIER,
      "_SM=", PARASITE_CYCLE_STEAL_MULTIPLIER
    ),
...
host_parent_tasks_all_time_by_task_plt <- host_parent_tasks_all_time_by_task %>%
  ...
  geom_col(alpha = 0.5) +
  scale_x_discrete() +
  facet_grid(MULT ~ task, labeller = label_both) +
  theme(
    legend.position = "none",
    axis.text.x = element_text(
      angle = 90,
