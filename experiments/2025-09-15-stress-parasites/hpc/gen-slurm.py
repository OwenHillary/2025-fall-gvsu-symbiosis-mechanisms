...
combos.register_var("PARASITE_DEATH_CHANCE")
combos.register_var("PARASITE_NUM_OFFSPRING_ON_STRESS_INTERACTION")
...
combos.add_val(
    ...
    [
        ...
        "-START_MOI 0 -BASE_DEATH_CHANCE 0.75",
