...
combos.register_var("sym_mode__COPY_OVER")

combos.add_val(
    "sym_mode__COPY_OVER",
    [
        # No symbionts
        "-START_MOI 0 -HEALTH_TYPE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        # Parasites
        "-START_MOI 1 -HEALTH_TYPE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 1 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        "-START_MOI 1 -HEALTH_TYPE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 2 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        "-START_MOI 1 -HEALTH_TYPE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 4 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        "-START_MOI 1 -HEALTH_TYPE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 8 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        "-START_MOI 1 -HEALTH_TYPE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 16 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        # Mutualists
        "-START_MOI 1 -HEALTH_TYPE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 1",
        "-START_MOI 1 -HEALTH_MODE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 2",
        "-START_MOI 1 -HEALTH_TYPE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 4",
        "-START_MOI 1 -HEALTH_TYPE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 8",
        "-START_MOI 1 -HEALTH_TYPE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 16"
    ]
)
