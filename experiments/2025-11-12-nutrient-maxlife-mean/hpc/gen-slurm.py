...
combos.add_val(
    "MAX_CYCLES__COPY_OVER",
    [
        "-HOST_MIN_CYCLES_BEFORE_REPRO 320 -HOST_AGE_MAX 320",
        "-HOST_MIN_CYCLES_BEFORE_REPRO 320 -HOST_AGE_MAX 420",
        "-HOST_MIN_CYCLES_BEFORE_REPRO 320 -HOST_AGE_MAX 640",
        "-HOST_MIN_CYCLES_BEFORE_REPRO 640 -HOST_AGE_MAX 640",
        "-HOST_MIN_CYCLES_BEFORE_REPRO 640 -HOST_AGE_MAX 740",
        "-HOST_MIN_CYCLES_BEFORE_REPRO 640 -HOST_AGE_MAX 1280"
    ]
)
