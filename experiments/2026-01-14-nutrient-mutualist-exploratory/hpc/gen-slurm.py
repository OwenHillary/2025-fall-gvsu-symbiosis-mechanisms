...
default_job_time_request = "12:00:00"
...
fixed_parameters = {
    ...
    # Important 
    "NUTRIENT_TYPE": "mutualist",

    "SYM_VERT_TRANS_RES": "0",
    "SYM_HORIZ_TRANS_RES": "128",
    "HOST_REPRO_RES": "256",

    "SYM_MIN_CYCLES_BEFORE_REPRO": "1",  
    "HOST_MIN_CYCLES_BEFORE_REPRO": "1",
    ...
    "PARASITE_BASE_TASK_VALUE_PROP": "1", # Not sure if this is relvant, but just incase it is

#    "NUTRIENT_INTERACTION_MULTIPLIER": "7",
#    "NUTRIENT_DONATE_PROP": ".8",
...
combos.register_var("NUTRIENT_DONATE_PROP")
