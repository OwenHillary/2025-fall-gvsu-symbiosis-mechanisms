...
experiment_slug <- "2025-10-31-nutrient-repotime-stealmult"
...
summary_data <- summary_data %>%
  ...
  mutate(
    treatment = paste0(
      " Host/Sym Min=", HOST_MIN_CYCLES_BEFORE_REPRO,
      "/", SYM_MIN_CYCLES_BEFORE_REPRO,
      " Steal=", NUTRIENT_STEAL_PROP,
      " Mult=", NUTRIENT_INTERACTION_MULTIPLIER
    )
  ) %>%
  mutate(
