...
combos.register_var("treatment__COPY_OVER")
combos.add_val(
    "treatment__COPY_OVER",
    [
        "-START_MOI 0 -HEALTH_TYPE parasite -VERTICAL_TRANSMISSION 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0.0",
        "-START_MOI 1 -HEALTH_TYPE parasite -VERTICAL_TRANSMISSION 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0.0",
        "-START_MOI 1 -HEALTH_TYPE mutualist -VERTICAL_TRANSMISSION 1 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 1.0",
        "-START_MOI 1 -HEALTH_TYPE mutualist -VERTICAL_TRANSMISSION 1 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 2.0",
        "-START_MOI 1 -HEALTH_TYPE mutualist -VERTICAL_TRANSMISSION 1 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 4.0",
        "-START_MOI 1 -HEALTH_TYPE mutualist -VERTICAL_TRANSMISSION 1 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 8.0"
    ]
)
