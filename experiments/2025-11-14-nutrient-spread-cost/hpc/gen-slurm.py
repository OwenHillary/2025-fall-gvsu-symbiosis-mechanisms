...
combos.add_val(
    ...
    [
        "-HOST_REPRO_RES 5 -SYM_HORIZ_TRANS_RES 2.5",
        "-HOST_REPRO_RES 20 -SYM_HORIZ_TRANS_RES 10",
        "-HOST_REPRO_RES 30 -SYM_HORIZ_TRANS_RES 15",
        "-HOST_REPRO_RES 40 -SYM_HORIZ_TRANS_RES 20",
        "-HOST_REPRO_RES 50 -SYM_HORIZ_TRANS_RES 25",
        "-HOST_REPRO_RES 100 -SYM_HORIZ_TRANS_RES 50",
        "-HOST_REPRO_RES 300 -SYM_HORIZ_TRANS_RES 150"
    ]
)
