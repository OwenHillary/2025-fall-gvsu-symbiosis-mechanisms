...
combos.add_val(
    ...
    [
        # No symbionts
        "-START_MOI 0 -HEALTH_MODE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        # Parasites
        "-START_MOI 1 -HEALTH_MODE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 1 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        "-START_MOI 1 -HEALTH_MODE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 2 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        "-START_MOI 1 -HEALTH_MODE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 4 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        "-START_MOI 1 -HEALTH_MODE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 8 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        "-START_MOI 1 -HEALTH_MODE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_CYCLE_STEAL_MULTIPLIER 16 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 0",
        # Mutualists
        "-START_MOI 1 -HEALTH_MODE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 1",
        ...
        "-START_MOI 1 -HEALTH_MODE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 4",
        "-START_MOI 1 -HEALTH_MODE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 8",
        "-START_MOI 1 -HEALTH_MODE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_CYCLE_STEAL_MULTIPLIER 0 -MUTUALIST_CYCLE_DONATE_MULTIPLIER 16"
    ]
)
