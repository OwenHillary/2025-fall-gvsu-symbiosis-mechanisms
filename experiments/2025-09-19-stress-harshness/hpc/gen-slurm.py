...
combos.register_var("STRESS__COPY_OVER")
combos.register_var("STRESS_FREQUENCY")

combos.add_val(
    "STRESS__COPY_OVER",
    [

        "-STRESS_TYPE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_DEATH_CHANCE 0.25 -MUTUALIST_DEATH_CHANCE 0.0 -BASE_DEATH_CHANCE 0.0",
        "-STRESS_TYPE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_DEATH_CHANCE 0.5 -MUTUALIST_DEATH_CHANCE 0.0 -BASE_DEATH_CHANCE 0.0",
        "-STRESS_TYPE parasite -VERTICAL_TRANSMISSION 0 -PARASITE_DEATH_CHANCE 0.75 -MUTUALIST_DEATH_CHANCE 0.0 -BASE_DEATH_CHANCE 0.0",

        "-STRESS_TYPE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_DEATH_CHANCE 0.0 -MUTUALIST_DEATH_CHANCE 0.0 -BASE_DEATH_CHANCE 0.25",
        "-STRESS_TYPE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_DEATH_CHANCE 0.0 -MUTUALIST_DEATH_CHANCE 0.0 -BASE_DEATH_CHANCE 0.5",
        "-STRESS_TYPE mutualist -VERTICAL_TRANSMISSION 1 -PARASITE_DEATH_CHANCE 0.0 -MUTUALIST_DEATH_CHANCE 0.0 -BASE_DEATH_CHANCE 0.75"
    ]
)
