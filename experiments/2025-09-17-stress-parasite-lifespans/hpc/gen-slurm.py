...
fixed_parameters = {
    ...
    "CYCLES_PER_UPDATE": "4",
    "FIND_NEIGHBOR_HOST_ATTEMPTS": "20",
    "VT_TASK_MATCH": "1",
    "TASK_PROFILE_MODE": "self-all",
    "TASK_PROFILE_COMPATIBILITY_MODE": "task-any-match",
    "HORIZONTAL_TRANSMISSION_COMPATIBILITY_MODE": "task-profile-stronger-match",
    "HOST_REPRO_RES": "10",
...
combos.register_var("START_MOI__COPY_OVER")
combos.register_var("LIFESPAN__COPY_OVER")

combos.add_val(
    "LIFESPAN__COPY_OVER",
    [
        "-HOST_MIN_CYCLES_BEFORE_REPRO 100 -SYM_MIN_CYCLES_BEFORE_REPRO 50",
        "-HOST_MIN_CYCLES_BEFORE_REPRO 150 -SYM_MIN_CYCLES_BEFORE_REPRO 75",
        "-HOST_MIN_CYCLES_BEFORE_REPRO 200 -SYM_MIN_CYCLES_BEFORE_REPRO 100",
        "-HOST_MIN_CYCLES_BEFORE_REPRO 200 -SYM_MIN_CYCLES_BEFORE_REPRO 200"
    ]
)

combos.add_val(
    "START_MOI__COPY_OVER",
    [
        "-START_MOI 0 -BASE_DEATH_CHANCE 0.5",
        "-START_MOI 1 -BASE_DEATH_CHANCE 0.0"
    ]
)
