...
combos.add_val(
    ...
    [
        ...
        "-HOST_ONLY_FIRST_TASK_CREDIT 1 -SYM_ONLY_FIRST_TASK_CREDIT 0",
        "-HOST_ONLY_FIRST_TASK_CREDIT 0 -SYM_ONLY_FIRST_TASK_CREDIT 1",
        "-HOST_ONLY_FIRST_TASK_CREDIT 0 -SYM_ONLY_FIRST_TASK_CREDIT 0"
    ]
)
